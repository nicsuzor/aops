...
| `/dump`             | skill   | "emergency handoff", "save work", "handover", "interrupted", "session end", "stop hook blocked"                                                                                                         | yes            | yes        | execution      | operations                    | Pauli — Comprehensive work handover and session closure                                     |
