...
| `/critic`           | command | "/critic"                                                                                                                                                                                               | no             | no         | conversational | framework, quality-assurance  | Strategic review agent — multi-level critique applying 10 cognitive moves                   |
| `/enforcer`         | command | "/enforcer", "axiom compliance", "rules check", "ultra vires", "post-hoc review"                                                                                                                        | no             | no         | execution      | framework                     | Post-hoc axiom compliance check — detects violations, ultra vires actions, workflow issues  |
