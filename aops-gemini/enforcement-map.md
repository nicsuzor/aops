...
| [[mandatory-handover]]                      | Mandatory Handover Workflow         | UserPromptSubmit (hint), skills/dump/SKILL.md Step 2                                               | UserPromptSubmit, Stop    |        |
| [[capture-outstanding-work]]                | Capture Outstanding Work            | skills/dump/SKILL.md Step 3 (MANDATORY: every follow-up → PKB task, not prose; use a task with status: seed for fuzzy items) | Stop                      |        |
