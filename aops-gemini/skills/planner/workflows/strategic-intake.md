...
2. **Search Before Placing** (P52) — Query PKB for existing related nodes. Use `mcp_pkb_search()` and `mcp_pkb_pkb_context()` to understand what already exists. Never create duplicates; link to or update existing nodes.
